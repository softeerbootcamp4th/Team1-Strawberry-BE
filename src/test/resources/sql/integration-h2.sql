...
VALUES (1, 1, '퀴즈 테스트', 1, 1, '2024-06-25 10:30:00', '2024-06-26 10:30:00',
        ...
        JSON '{"main": "https://softeer-static.s3.ap-northeast-2.amazonaws.com/event_info.svg"}',
        JSON '{"1": {"prizeId": 1, "winnerCount": 1}}'),
       ...
       (4, 1, '드로잉', 0, 0, '2024-08-01 10:30:00', '2024-09-30 10:30:00',
        ...
        JSON '{"how": "https://softeer-static.s3.ap-northeast-2.amazonaws.com/drawingLottery/drawingEvent_how.svg",
                "reward": "https://softeer-static.s3.ap-northeast-2.amazonaws.com/drawingLottery/drawingEvent_reward.svg",
                "description": "https://softeer-static.s3.ap-northeast-2.amazonaws.com/drawingLottery/drawingEvent_discription.svg"}',
        JSON '{"1": {"prizeId": 1, "winnerCount": 1}}');
...
VALUES (1, 4, '1차 드로잉', 1,
        ...
        '3초 후 디 올 뉴 싼타페를 그려주세요!', '7초 안에 선을 따라 디 올 뉴 싼타페를 그려주세요!'),
       (2, 4, '2차 드로잉', 2,
