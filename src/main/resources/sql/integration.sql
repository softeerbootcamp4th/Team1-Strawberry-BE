...
INSERT INTO events (id, end_at, event_name, event_registered_at, event_status, start_at, winner_count, car_id, event_img_urls)
VALUES (1, '2024-07-01 10,00:00', '별 헤는 밤', '2024-06-28 00:00:00', 0, '2024-06-25 10:00:00', 10, 1, JSON_OBJECT(
...
values (1, 1, "퀴즈 테스트", 1, 1, "2024-08-06 10:30:00", "2024-08-09 10:30:00", "www.banner1.com", json_object('main', 'www.event1.com')),
       (2, 1, "ㅣ히히", 1, 1, "2024-08-12 10:30:00", "2024-08-15 10:30:00", "www.banner2.com", json_object('main', 'www.event1.com')),
       (3, 1, "퀴즈 시러", 1, 1, "2024-08-19 10:30:00", "2024-08-22 10:30:00", "www.banner3.com", json_object('main', 'www.event1.com'));
