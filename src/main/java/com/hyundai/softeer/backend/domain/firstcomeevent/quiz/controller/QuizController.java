...
public class QuizController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "정상 반환 시", content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = QuizResponseDto.class))}),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "정상 반환 시", content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = QuizLandResponseDto.class))}),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "퀴즈 채점이 정상적으로 처리되었을 때", content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = QuizSubmitResponseDto.class))}),
